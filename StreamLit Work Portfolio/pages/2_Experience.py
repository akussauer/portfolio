...
aquatics_gb = [
    "Performan notational analysis of swimming competitions",
    "Develop and implement custom data managment programs",
...
city_of_nanaimo = [
    ...
    "Built and maintained Baseball diamonds to a high standard",
