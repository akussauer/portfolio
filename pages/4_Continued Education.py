...
st.header("Continued Education & Interests")
st.divider()
st.markdown("### Continued Education")
...
NSCA_2023_content = {
    ...
    "STRENGTH: The Foundation of Performance" : "Paul Comfort, Ph.D, CSCS*D, ASCC",
    "Transfer of Training: Elite Athletes" : "William A Sands, PhD, FACSM",
    "Dancers as Athletes: Reccommendations for Enhancing Competative Performance" : "Josh Wludyga, DSc, CSCS*D",
